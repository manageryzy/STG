...
public class OBJModel
{
  ...
  private boolean hasTCs3D = true;     // whether the model uses 3D or 2D tex coords
  ...
  public OBJModel(String nm, GL10 gl)
  {  this(nm, 1.0f, gl, false);  }


  public OBJModel(String nm, float sz, GL10 gl, boolean showDetails)
  {
    modelNm = nm;
    maxSize = sz;
...
*/
  ...
  drawn quicker later */
  private void drawToList(GL10 gl)  
  {
