...
public class Material
{
  ...
  public void setMaterialColors(GL10 gl)
  ...
  public void loadTexture(String fnm)
  {
    try {
      ...
      texture.setTexParameteri(null, GL.GL_TEXTURE_MAG_FILTER, GL.GL_NEAREST);
      texture.setTexParameteri(null, GL.GL_TEXTURE_MIN_FILTER, GL.GL_NEAREST);
    }
    catch(Exception e)
